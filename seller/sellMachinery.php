  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Sell Machinery</h1>

        <form action="" method="POST" enctype="multipart/form-data">

        <div class="form-group">
            <label for="machineryName">Machinery Name</label>
            <input type="text" class="form-control" name="machineryName" required>
        </div>
        <div class="form-group">
        <label for="machineryDescription">Machinery Description</label>
        <textarea class="form-control" name="machineryDescription" required></textarea>
        </div>
        <div class="form-group">
            <label for="machineryQuantity">Machinery Quantity</label>
            <input type="number" class="form-control" name="machineryQuantity" aria-describedby="quantityHelp" required>
            <small id="quantityHelp" class="form-text text-muted">Quantity is number of machineries available for sale</small>
        </div>
        <div class="form-group">
            <label for="machineryPrice">Machinery Price</label>
            <input type="number" class="form-control" name="machineryPrice" aria-describedby="priceHelp" required>
            <small id="priceHelp" class="form-text text-muted">Price must be per single machines</small>
        </div>
        <!-- <div class="form-group"> -->
            <label for="machineryImage">Machinery Image</label>
...
<?php include('sellMachineryServer.php'); ?>
  </div>
  <!-- /#wrapper -->
