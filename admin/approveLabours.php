...
<?php include '../connection.php' ?>
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-dark text-white border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a class="list-group-item list-group-item-action bg-dark"><button type="submit" class="text-white" name="logout" style="border:none; background: none;">Logout</button></a>
</form>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Approve Farmers</h1>
  ...
  <tbody>
        ...
        <?php
          $query= "SELECT * FROM userdetails WHERE userType='labourer' AND acStatus='pending'";
