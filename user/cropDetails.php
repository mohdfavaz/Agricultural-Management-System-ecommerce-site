      ...
      <div class="container-fluid">
       ...
       <div class="productDetails border mt-4" style="display: flex;">
         ...
         <div class="productDetails mt-2 ml-2">
           ...
           <h1 class="text-warning m-4">Rs. <?php echo $data['productPrice']; ?> /KG</h1>
      
             <label for="cropQuantity"><h4 class="text-primary">SELECT QUANTITY:</h4></label>
             <select id="quantity">
...
<script src="vendor/jquery/jquery.min.js"></script>
  ...
  <script>
    ...
    $(".buyNow").click(function(){
     ...
     window.location.href="placeCropOrder.php?id="+id+"&quantity="+quantity;
    });
  </script>
    </body>
