...
<?php include '../connection.php' ?>
      ...
      <div class="container-fluid border m-2 p-2">
          ...
          <form class="mt-2" action="" method="POST"> 
            ...
            <div class="form-group">
              ...
              <input type="tel" maxlength="10" minlength="10" class="form-control" pattern="[0-9]{10}" title="A phone number should contain 10 digits" name="phoneNumber" required>
            </div>
  ...
  <?php include('fertilizerOrderServer.php') ?>
