...
<body>
  ...
  <div class="container-fluid">
    ...
    <section id="sellCrops">
        <h3 class="text-center mt-4 md-4">SELL MACHINERY</h3>
        <div class="container-fluid" style="width: 80%;">
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="machinePrice" name="machinePrice">
                </div>
                <div class="form-group">
    ...
    <textarea class="form-control" id="machineDescription" rows="3"></textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="file" accept="image/jpg,image/jpeg" class="form-control" id="machineImage" name="machineImage">
                </div>
